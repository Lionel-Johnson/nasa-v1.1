...
?>
	...
	<!-- title of this page -->
		<title>Admin - Résultats des Départements/Fédérations</title>
								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="obtain_marks[]" placeholder="Veuillez entrer les données Obtenues" class="form-control" required></td>
