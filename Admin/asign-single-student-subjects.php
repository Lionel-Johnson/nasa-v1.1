...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			...
			if ($run) {
				$success_message = "Tous les sujets ont été attribués avec succès au militant";
			}	
			else{
				$error_message = "Tous les sujets n'ont pas été attribués avec succès au militant";
			}
		}
	}
...
?>
	...
	<!-- title of this page -->
		<title>Admin - Attribuer le sujet au Militant</title>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Attribuer un sujet à un seul militant </h4>
				</div>
				<div class="row">
					<div class="col-md-12">
					<div class="col-md-12">
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Selectionner un Département:</label>
										<select class="browser-default custom-select" name="course_code">
											<option >Selection du Département</option>
											<?php
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Entrer l'ID du Militant:</label>
										<input type="text" name="roll_no" class="form-control" placeholder="Entrer l'ID">
									</div>
								</div>
								<div class="col-md-4">
					...
					<div class="col-md-12 ml-2">
						<section class="border mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								?>
								        <input class="btn btn-success px-5 my-1" type="submit" name="soumettre">
