...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			...
			if ($run) {
				$success_message = "Tous les résultats ont été soumis avec succès";
			}	
			else{
				$error_message = "Tous les résultats n'ont pas été soumis avec succès";
			}
		}
	}
...
?>
	...
	<!-- title of this page -->
		<title>Admin - Page des Résultats</title>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Système de gestion des résultats </h4>
					<a class="btn btn-outline-primary ml-auto mr-2 text-white" href="add-single-student-results.php">Résultat d'un seul militants</a>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-12">
							...
							<div class="row mt-3">
								<div class="col-md-4">
									<div class="form-group" style="z-index: 10;">
										<label>Selectionner un Département:</label>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="exampleInputEmail1">Selectionner un Siège:</label>
										<select class="browser-default custom-select" name="semester">
											<option >Selectionner un Siège</option>
											<?php
								...
								<div class="col-md-4">
									<input type="submit" name="submit" class="btn btn-primary px-5" value="Presser">
								</div>
							</div>	
						</form>
					</div>
								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="obtain_marks[]" placeholder="SVP, entrer les notes obtenues" class="form-control"></td>
