...
<html lang="en">
	<head>
		<title>Admin - Fréquentation des militants</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Système de gestion de l'assiduité des militants </h4>
				</div>
				<div class="row w-100">
					<div class="col-md-12">
							...
							<div class="row mt-3">
								<div class="col-md-4">
									<div class="form-group" style="z-index: 10;">
										<label>Entrer l'ID du Département:</label>
								...
								<div class="col-md-4">
									...
									<label for="exampleInputEmail1">Selectionner un Siège/une Section:</label>
										<select class="browser-default custom-select" name="semester">
											<option >Selectionner un Siège/une Section</option>
											<?php
											$teacher_id=$_SESSION['teacher_id'];
