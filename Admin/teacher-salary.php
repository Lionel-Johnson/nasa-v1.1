 	...
 	if (isset($_POST['btn_sub'])) {
 		...
 		while ($row=mysqli_fetch_array($run)) {
	 		...
	 		<?php }
	 			...
	 			<script type="text/javascript">
	 				alert("Le salaire n'a pas été payé en raison d'erreurs");
	 			</script>
	 		<?php }
 	    }
 	}
...
<html lang="en">
	<head>
		<title>Admin - Salaires des Secrétaires des Sections</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">Système de gestion des salaires des secrétaires des sections </h4>
						<button type="button" class="btn btn-primary ml-5 mr-5" data-toggle="modal" data-target=".bd-example-modal-lg">Ajouter une échelle de salaire</button>
						<button type="button" class="btn btn-primary ml-5" data-toggle="modal" data-target=".add_salary">Ajouter un Salaire</button>
					</div>
				</div>
				<div class="row">
										...
										<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header bg-info text-white">
														<h4 class="modal-title text-center">Ajouter un Salaire</h4>
													</div>
													<div class="modal-body">
														<form action="teacher-salary.php" method="post">
															<div class="row mt-3">
																<div class="col-md-6 pr-5">
																	<div class="form-group">
																		<label for="exampleInputEmail1">L'I'd du SS: </label>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1">Allocation médicale: </label>
																		<input type="text" name="medical_allowance" class="form-control" placeholder="Enter Medical Allowance">
																	</div>
																</div>
																<div class="col-md-6">
																	<div class="formp">
																		<label for="exampleInputEmail1">Allocation de logement: </label>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="formp">
																		<label for="exampleInputEmail1">Échelle payée: </label>
														...
														<form action="teacher-salary.php" method="post">
															<div class="row mt-3">
																<div class="col-md-12 pr-5">
																	<div class="form-group">
																		<label for="exampleInputEmail1">L'I'd du SS: </label>
																		<input type="text" name="teacher_id" class="form-control" placeholder="Entrer L'Id du SS">
																	</div>
																</div>
															</div>
															<div class="modal-footer">
																<input type="submit" class="btn btn-primary" name="btn_sub" value="Enregistrer des données">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
															</div> 	
														</form>
													</div>
