...
?>
    ...
    <title>Relevé des des notes des ernolements</title>

<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/icbs_logo.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">AYSTEME DE GESTION DES DONNEES PERSONNALISEES DES MILITANTS DU PDG - ICBS*</h4>
            <h4 class="text-dark">OUTILS DE SUIVI DES ELECTIONS AU GABON</h4>
        </div>
    </div>
        ...
        <div class="program-info">
            <?php  
                ...
                while($row = mysqli_fetch_array($run)){ ?>
                    <h5>Relevé des Militants de base <?php echo $row['course_code']; ?> Désignation</h5>
        </div>
        <div class="d-flex mt-3">
            <div>
                <h5>Nom du Militant: <?php echo $row['first_name']. " ". $row['middle_name']. " ". $row['last_name']; ?></h5>
                <h5>S/O : <?php echo $row['father_name']; ?></h5>
            </div>
            <div class="ml-auto">
                <h5>I.D  Militant# : <?php echo $row['roll_no']; ?></h5>
                <h5>Date d'adhédion : <?php echo intval($row['admission_date']) . " ". $row['session_name']; ?></h5>
            </div>
        </div>
        <?php }
        ?>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Siège - 1</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Siège CV</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">SSiège- 2</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Sièges CV</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Siège - 3</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Siège - 4</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Siège CDE</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Arrondissemnt - 1</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Militant dans l'Arr</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Arrondissemnt - 2</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Arrondissement- 3</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>CB</th>
                                    <th>Letter</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Arrondissement- 4</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>CB</th>
                                    <th>Letter</th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">CDE- 1</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Militant CDE</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">CDN - 1</span><span class="ml-5"><?php echo  $assign_date. " ".$session; ?> </span></div></th>
                                    <th>CV</th>
                                    <th>%</th>
                                    <th>BV</th>
                                    <th>Lettre</th>
                                ...
                                ?>
                                <tr>
                                    <th colspan="2">Total Militant CDN</th>
                                    <?php $total_semester_ch = $total_semester_ch + $total_ch; ?>
                                    <th><?php echo $total_ch; ?></th>
                                    <th></th>
                                    <th></th>
                                ...
                                <tr>
                                    <th colspan="2">TOATALE EVALUATION</th>
                                    ...
                                    <th colspan="2">Comm POG Complété</th>
    ...
    <div class="container-fluid">
        <div class="row text-center font-weight-bold mb-5">
            <div class="col-xl-4">PREPARE PAR</div>
            <div class="col-xl-4">LA NASA</div>
            <div class="col-xl-4">CONTROLLEUR EXAMINATIONS</div>
        </div>
    </div>
